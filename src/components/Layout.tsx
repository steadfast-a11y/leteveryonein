...
const Logo = () => (
  <Link to="/" aria-label="LetEveryoneIn — Home" className="flex items-center gap-2 text-foreground">
    <svg viewBox="-22 -4 418 558" aria-hidden="true" fill="currentColor" style={{ height: '2.4em', width: 'auto', flexShrink: 0 }}>
  ...
  <footer className="border-t border-border bg-neutral-100 py-12 px-4">
    <div className="container mx-auto max-w-6xl">
      ...
      <div className="mt-8 pt-6 border-t border-border text-sm text-muted-foreground">
        © {new Date().getFullYear()} LetEveryoneIn. All rights reserved.
      </div>
    </div>
  </footer>
);
